...
**FocusGuard** 是一款融合了**计算机视觉 (CV)** 与 **游戏化** 理念的基于**Python**开发的桌面端健康辅助系统。

针对现代学生和办公人群长期面对屏幕导致的体态问题与视疲劳，本项目采用**前后端分离架构**。后端利用 **MediaPipe** 实时分析面部网格与身体骨骼；前端通过 **RPG 升级机制**，将枯燥的“保持专注”转化为有趣的“打怪升级”体验，帮助用户在沉浸式体验中养成健康的办公习惯。

> **🎨 设计理念**：采用 **赛博朋克** 视觉风格，结合 CSS3 毛玻璃特效、流光动画与 HUD 界面，打造未来科技感的交互体验。
...
|  成员  | 角色 | 主要职责 |
| --- | --- | --- |
| **张天译** | **组长** / 全栈开发 / 文档 | 统筹全组工作进度，系统架构整体设计，前后端整合&优化，多场景系统测试，项目功能拓展，撰写实验报告与用户手册，录制展示视频 |
| **龙辅仁** | 总体设计 / 前端界面开发 | 需求分析，开发前端界面框架 |
| **李紫嫣** | 后端逻辑 / 数据库设计 | RESTful API 设计，数据库结构设计，多用户系统逻辑实现 |
| **赵迎迎** | 后端核心算法 | Python CV 核心实现 (MediaPipe Pose/Face)，坐姿判定与疲劳算法设计 |
